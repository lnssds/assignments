...
def apply_transform(image, scale, rotation, translation_x, translation_y, flip_horizontal):
    ...
    matrix_translate_to_origin = np.array([
        [1, 0, -center_x],
        [0, 1, -center_y],
        [0, 0, 1]
    ], dtype=np.float32)
    ...
    matrix_translate_back = np.array([
        [1, 0, center_x + translation_x],
        [0, 1, center_y + translation_y],
        [0, 0, 1]
    ], dtype=np.float32)

    combined_matrix = matrix_translate_back @ matrix_rotate @ matrix_scale @ matrix_translate_to_origin
